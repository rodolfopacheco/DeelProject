...
class FeatureFormatter {
    constructor(gherkinFeature, jsonFeature) {
        ...
        this.scenarioFormater = new scenario_formatter_1.ScenarioFormatter(this.gherkinFeature);
    ...
    addFirstScenarioOutline(scenarios, jsonScenario, index) {
        const scenarioName = jsonScenario.name;
        const gherkinScenario = this.gherkinFeature?.children?.filter(scenario => scenario.scenario?.name === scenarioName)[0]?.scenario;
    ...
    updateFeatureStadistics(scenarioResults) {
