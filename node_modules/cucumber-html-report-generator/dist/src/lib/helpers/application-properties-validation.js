...
exports.userPropertiesValidation = void 0;
const CommonFunctions = __importStar(require("../common-functions/common-functions"));
const Messages = __importStar(require("./console-messages"));
class ApplicationPropertiesValidation {
    checkReportGenerationParameters(reportGenerationParameters) {
    ...
    initializeReportGenerationParameters(reportGenerationParameters) {
    ...
    initializeReportDisplayParameters(reportConfigurationParameters) {
...
exports.userPropertiesValidation = new ApplicationPropertiesValidation();
//# sourceMappingURL=application-properties-validation.js.map