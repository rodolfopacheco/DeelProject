...
export declare const streamToArrayAsync: (stream: Readable) => Promise<CucumberMessage[]>;
...
export declare const convertTimeFromNanoSecondsToHHMMSS: (time: number, ceilBy?: string) => string;
export declare const arraymove: <T>(arr: T[], fromIndex: number, toIndex: number) => T[];
